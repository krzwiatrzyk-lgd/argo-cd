...
func (r *ApplicationSetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (result ctrl.Result, err error) {
	...
	// progressiveSyncRequeue is the requeue hint the progressive sync pass asks for, zero when it
	// needs none. It is folded into requeueAfter at the end of the reconcile.
